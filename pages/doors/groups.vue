...
const groups = ref([
    { name:'Unassigned', count: 24, },
    { name:'Internal Doors', count: 4, },
    { name:'External Doors', count: 14, },
]);
    ...
    <DoorsLayout>
        ...
        <div class="flex items-center justify-between font-roboto mb-5">
            ...
            <div class="flex items-center rounded-md bg-blue px-3 py-2.5">
                ...
                <p class="text-white font-semibold">New Group</p>
            </div>
        </div>
        <DoorsGroupTable :groups="getGroups"/>
